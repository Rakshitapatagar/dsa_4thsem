...
void levelOrder(struct Node* root,FILE* file)
 {
...
int main()
{
    ...
    FILE* levelOrderfile=fopen("levelorder.txt","w");
    if(levelOrderfile==NULL)
    {
        printf("failed\n");
    return 1;
    }
    levelOrder(root,levelOrderfile);
    fclose(levelOrderfile);

    printf("created IN-order output file.\n");
    printf("created PRE-order output file.\n");
    printf("created POST-order output file.\n");
    printf("created level-order output file.\n");
